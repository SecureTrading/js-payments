...
export default class Selectors {
  ...
  public static readonly NOTIFICATION_FRAME_FADE_CLASS: string = 'notification-frame--fade';
  public static readonly NOTIFICATION_FRAME: string = 'notification-frame';
