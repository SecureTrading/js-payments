...
import ST from '../../src/frontend/ST';

window.alert = jest.fn();

jest.mock('../../src/backend/core/shared/DomMethods');
jest.mock('../../src/frontend/classes/CommonFrames.class');
jest.mock('../../src/frontend/classes/CardFrames.class');
jest.mock('../../src/backend/core/integrations/CardinalCommerce');
jest.mock('../../src/backend/core/integrations/CardinalCommerceMock');
jest.mock('../../src/backend/core/integrations/VisaCheckout');
jest.mock('../../src/backend/core/integrations/VisaCheckoutMock');
jest.mock('../../src/backend/core/integrations/ApplePay');
jest.mock('../../src/backend/core/integrations/ApplePayMock');
jest.mock('../../src/backend/core/integrations/GoogleAnalytics');
