...
describe('ControlFrame', () => {
  ...
  describe('_getPan()', () => {
    ...
    it('should return pan from jwt', () => {
      // @ts-ignore
      instance._cardNumber = '411111111111';
      // @ts-ignore
      instance.params = {
        jwt:
          'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..-M6z1w29Ic204xG06XjGkD0Gq7JaVPBBkArhYri0Lzs'
      };
      // @ts-ignore
      expect(instance._getPan()).toEqual('411111111111');
    });
  });
